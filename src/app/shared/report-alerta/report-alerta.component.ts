...
@Component({
  selector: 'app-report-alerta',
  templateUrl: './report-alerta.component.html',
  styleUrls: ['./report-alerta.component.css']
})
export class ReportAlertaComponent implements OnInit {
